...
export default function WatsonxOptions({ settings }) {
  ...
  const [GuardRailsEnabled, setGuardRailsEnabled] = useState(
    settings?.WatsonxGuardRailsEnabled === "False" ? false : true || false
  );
  return (
      ...
      <div className="w-full flex items-center gap-4">
        <div className="flex flex-col w-60">
          ...
          <select
            name="WatsonxModel"
            defaultValue={
              settings?.WatsonxModel || "ibm/granite-20b-multilingual"
            }
            className="bg-zinc-900 text-white placeholder:text-white/20 text-sm rounded-lg focus:border-white block w-full p-2.5"
            required={true}
          >
            <option value={"sdaia/allam-1-13b-instruct"}>
              allam-1-13b-instruct
            </option>
            <option value={"codellama/codellama-34b-instruct-hf"}>
              codellama-34b-instruct-hf
            </option>
            <option value={"elyza/elyza-japanese-llama-2-7b-instruct"}>
              elyza-japanese-llama-2-7b-instruct
            </option>
            <option value={"google/flan-t5-xxl"}>flan-t5-xxl-11b</option>
            <option value={"google/flan-ul2"}>flan-ul2-20b </option>
            <option value={"ibm/granite-8b-japanese"}>
              ibm/granite-8b-japanese
            </option>
            <option value={"ibm/granite-13b-chat-v2"}>
              granite-13b-chat-v2
            </option>
            <option value={"ibm/granite-20b-multilingual"}>
              granite-20b-multilingual
            </option>
            <option value={"ibm/granite-3b-code-instruct"}>
              granite-3b-code-instruct
            </option>
            <option value={"ibm/granite-8b-code-instruct"}>
              granite-8b-code-instruct
            </option>
            <option value={"ibm/granite-20b-code-instruct"}>
              granite-20b-code-instruct
            </option>
            <option value={"ibm/granite-34b-code-instruct"}>
            ...
            <option value={"mistralai/mixtral-8x7b-instruct-v01"}>
              mixtral-8x7b-instruct-v01
            </option>
            <option value={"ibm-mistralai/mixtral-8x7b-instruct-v01-q"}>
        ...
        <div className="flex flex-col w-60">
          ...
          <input
            ...
            defaultValue={
              settings?.WatsonxEmbeddingModelPref || "baai/bge-large-en-v1"
            }
            required={true}
            autoComplete="off"
            spellCheck={false}
